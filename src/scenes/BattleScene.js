...
export class BattleScene extends Phaser.Scene {
    ...
    create() {
        ...
        if (this.player.hp <= 0) {
            console.warn("Player started with 0 HP! Forcing heal.");
    ...
    playCard(card, target) {
        ...
        // 3. Сжигание или Сброс (ВОТ ТУТ БЫЛА ОШИБКА)
